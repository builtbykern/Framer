...
/**
 * Zoom Image Intro — Marketplace product (prefer over ZoomImagesPreloader).
 *
 * Cinematic stacked zoom-in sequence for hero intros / page reveals.
 ...
 */
export default function ZoomImageIntro(props: Partial<ZoomImageIntroProps>) {
    const {
        images: imagesProp,
...
addPropertyControls(ZoomImageIntro, {
    images: {
        title: "Images",
...
ZoomImageIntro.displayName = "Zoom Image Intro"
