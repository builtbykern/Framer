...
interface BuiltByKern_NoiserProps {
    amount: number
    tint: string
    size: number
    animate: boolean
 ...
 */
export default function BuiltByKern_Noiser(
    props: Partial<BuiltByKern_NoiserProps>
) {
    const {
        amount = 22,
        tint = "#111111",
...
addPropertyControls(BuiltByKern_Noiser, {
    amount: {
