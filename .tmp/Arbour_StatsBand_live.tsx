...
// Craft pass 2026-08-11: chrome slim (index+hairline), column-aligned values, surface bake off, snappier entrances.
...
function translateY3d(y: number): string {
...
function StatRow({
    ...
    const justifyValue = isWide || mode === "compact" ? "flex-end" : "flex-start"
    ...
    const enterDuration = subtle ? 0.24 : 0.32
    const childDuration = subtle ? 0.2 : 0.28
    const rowEnterY = subtle ? 12 : 24
    const regionEnterY = subtle ? 12 : 42
    const indexEnterY = subtle ? 6 : 12
    const labelEnterY = subtle ? 8 : 10
    const valueEnterY = subtle ? 10 : 14
    const valueContent =
    ...
    if (semanticMode === "description-list") {
        const groupedRowStyle: CSSProperties = {
            ...
            borderTop: `1px solid ${toRGBA(borderColor, 0.56)}`,
            display: "grid",
            ...
            <motion.div
                ...
                initial={
                    activeMotionMode === "off"
                        ? false
                        : { opacity: 0, transform: translateY3d(rowEnterY) }
                }
                animate={
                    isVisible
                        ? { opacity: 1, transform: translateY3d(0) }
                        : { opacity: 0, transform: translateY3d(rowEnterY) }
                }
                transition={{
            ...
            >
                <motion.span
                    ...
                    initial={
                        activeMotionMode === "off"
                            ? false
                            : { opacity: 0, transform: translateY3d(indexEnterY) }
                    }
                    animate={
                        isVisible
                            ? { opacity: 1, transform: translateY3d(0) }
                ...
                <motion.dt
                    ...
                    initial={
                        activeMotionMode === "off"
                            ? false
                            : { opacity: 0, transform: translateY3d(labelEnterY) }
                    }
                    animate={
                        isVisible
                            ? { opacity: 1, transform: translateY3d(0) }
                ...
                <motion.dd
                    ...
                    initial={
                        activeMotionMode === "off"
                            ? false
                            : { opacity: 0, transform: translateY3d(valueEnterY) }
                    }
                    animate={
                        isVisible
                            ? { opacity: 1, transform: translateY3d(0) }
            ...
            <div style={revealMaskStyle}>
                <motion.div
                    ...
                    initial={
                        activeMotionMode === "off"
                            ? false
                            : { opacity: 0, transform: translateY3d(regionEnterY) }
                    }
                    animate={
                        isVisible
                            ? { opacity: 1, transform: translateY3d(0) }
