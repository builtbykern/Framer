...
interface SeriesStillsProps {
    ...
    still1?: ResponsiveImage | string | null
    still2?: ResponsiveImage | string | null
    still3?: ResponsiveImage | string | null
    still4?: ResponsiveImage | string | null
    desktop?: LayoutMode
    tablet?: LayoutMode
    phone?: LayoutMode
    layout?: LayoutMode
...
export default function SeriesStills(props: SeriesStillsProps) {
    ...
    const slotStills = [still1, still2, still3, still4]
        .map((slot) => resolveAsset(slot ?? null))
        .filter(Boolean) as Array<{
        src: string
        srcSet?: string
        alt: string
...
addPropertyControls(SeriesStills, {
    ...
    still1: {
        type: ControlType.ResponsiveImage,
        title: "Still 1",
        description: "Work → Still 1. Single-image bind, so the editor canvas can paint it.",
    },
    still2: {
        type: ControlType.ResponsiveImage,
        title: "Still 2",
        description: "Work → Still 2.",
    },
    still3: {
        type: ControlType.ResponsiveImage,
        title: "Still 3",
        description: "Work → Still 3.",
    },
    still4: {
        type: ControlType.ResponsiveImage,
        title: "Still 4",
        description: "Work → Still 4.",
    },
    desktop: {
