...
- Enable Framer prefers-reduced-motion / reduced motion in Site Settings if the control exists. Then: Nav overlay instant, BrandRoll loop off, Scrim and Y instant, Page Effect Instant if it still exists, plane without idle drift (desktop)
