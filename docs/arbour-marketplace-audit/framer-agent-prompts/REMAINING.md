...
3. **Antes** de enviar: `@` la página y **selecciona el layer**.
4. Si acaba el job, **para**.
...
Do not add, delete, unpublish, or rename notes. Stop.

---

## 02 — Hover en 3 links de Home
